...
$$'),
            ...
            h5("The main advantage of random forest method is that by averaging results across many trees it decreases variance compared to a single tree fit.  Random forest improves over bagging by using the random subset of predictors which reduces variance compared to bagging and usually results in a better fitting model."),
            br(),br(),br()
          )         
        ),
        ##Model Fitting Tab
