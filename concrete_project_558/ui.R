      ...
      sidebarPanel(
        ...
        checkboxInput("subdata", h4("Subset Data", style = "color:green;")),          conditionalPanel("input.subdata", 
              ...
              sliderInput("FineSlide","Fine_Aggregate Range",
                          ...
                          max = round(max(fullData$Fine_Aggregate)),
          ...
          sliderInput("ConcreteSlide","Concrete_Compressive_Strength Range",
                      min = round(min(fullData$Concrete_Compressive_Strength)),
                      max = round(max(fullData$Concrete_Compressive_Strength)),
    ...
    sidebarLayout(
      sidebarPanel(
        ...
        conditionalPanel(
          ...
          pickerInput("corSelect", "Correlation Variables",
                             choices = colnames(fullData),
                             selected = colnames(fullData),
                             multiple = TRUE),
        ),
        ...
        conditionalPanel(
          ...
          pickerInput("fiveSelect", "Summary Variables",
                             choices = colnames(fullData),
                             selected = colnames(fullData),
                             multiple = TRUE),
        ),
        conditionalPanel(
          ...
          pickerInput("threeSelect", "Summary Variables",
                             choices = colnames(fullData),
                             selected = colnames(fullData),
                             multiple = TRUE),
        ),
       conditionalPanel(
          ...
          pickerInput("contSelect", "Summary Variables",
                     choices = colnames(fullData),
                     selected = colnames(fullData),
                     multiple = TRUE),
)
